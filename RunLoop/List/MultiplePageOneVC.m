...
#import "MultiplePageOneVC.h"
#import "CommCell.h"
#import "TimerManager.h"

static NSString *iden = @"celliden";

NSString *const MultiplePageSource1 = @"MultiplePageSource1";


@interface MultiplePageOneVC ()<UITableViewDelegate,UITableViewDataSource>
...
@implementation MultiplePageOneVC

- (void)viewDidLoad {
    
    self.tabBarController.title = @"页面倒计时1";
    ...
    // 增加倒计时源
    [KCountDownManager addSourceWithIndentifier:MultiplePageSource1];
...
- (NSArray *)data1{
    if (!_data1) {
        ...
        for (NSInteger i = 0; i < 50; i++) {
            ...
            model.countDownSource = MultiplePageSource1;
...
- (void)dealloc{
    ...
    [KCountDownManager removeSourceWithIdentifier:MultiplePageSource1];
